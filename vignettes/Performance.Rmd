...
ptm <- proc.time()
  ...
  result1 <- lin_polylog_framed_clust(Data_Points, width, K, First, Last, Prev, Next)
  ...
  result2 <- quad.framed.clust(Data_Points, K, First, Last, width)
  ...
  result3 <- kmeans.framed.clust(Data_Points, K, First, Last, width)
